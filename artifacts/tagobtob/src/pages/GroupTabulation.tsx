    ...
    <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-wrap items-center justify-end gap-3">
          ...
          <Button type="button" variant="outline" onClick={() => window.print()} data-testid="button-print-group-results">
            ...
            <Table className="border-0">
              ...
              <TableBody>
                  {sortedEntries.map((entry) => (
                    <TableRow 
                      key={entry.schoolCode} 
                      className={`border-border group transition-colors hover:bg-accent/70 ${entry.rank === 1 ? 'bg-primary/5' : ''}`}
